...
describe('RolesController', () => {
    ...
    it('should call findAll method of RolesService', async () => {
      const roles = [
        ...
        },
        {
          ...
          code: 'ADMIN',
          name: 'Administrador',
          description: 'Rol del administrador con todos los permisos',
  ...
  describe('findOne', () => {
    ...
    it('should throw an error if role does not exist', async () => {
      mockRolesService.findOne.mockRejectedValue(new Error('Role does not exist'));
  ...
  describe('update', () => {
    ...
    it('should throw an error if role does not exist', async () => {
      const dto = { name: 'Nuevo nombre' };
      mockRolesService.update.mockRejectedValue(new Error('Role does not exist'));
    ...
    it('should throw an error if no fields are provided for update', async () => {
      ...
      mockRolesService.update.mockRejectedValue(
        new Error(
          'At least one field (name, description or permissions) must be provided for update',
        ),
      );
    ...
    it('should throw an error if permissions array is empty', async () => {
      ...
      mockRolesService.update.mockRejectedValue(new Error('Permissions array cannot be empty'));
    ...
    it('should throw an error if permissions array contains invalid ids', async () => {
      ...
      mockRolesService.update.mockRejectedValue(new Error('Some permissions do not exist'));
    ...
    it('should throw an error if any field is empty or invalid', async () => {
      const dto = { name: '' };
      mockRolesService.update.mockRejectedValue(new Error('Fields cannot be empty or invalid'));
  ...
  describe('remove', () => {
    ...
    it('should throw an error if role does not exist', async () => {
      mockRolesService.remove.mockRejectedValue(new Error('Role does not exist'));
