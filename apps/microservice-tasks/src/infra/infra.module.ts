...
@Module({
    imports: [TypeOrmModule.forFeature([Dashboard, ParticipantType, Priority, RolDashboard, Status, Task])],
    providers: [
    ...
    exports: [DASHBOARD_REPO, PARTICIPANT_TYPE_REPO, PRIORITY_REPO, ROL_DASHBOARD_REPO, STATUS_REPO, TASK_REPO],
})
