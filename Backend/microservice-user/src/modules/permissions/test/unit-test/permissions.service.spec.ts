...
// Mock Role entity for the many-to-many relationship
interface MockRole {
  id: number;
  name: string;
  // Add other required Role properties if needed
}
...
describe('PermissionsService', () => {
  ...
  describe('create', () => {
    it('should create and save a permission', async () => {
      const dto: CreatePermissionDto = { name: 'verTareas', description: 'desc' };
  ...
  describe('findOne', () => {
    it('should return a permission if found', async () => {
      const perm: Permission = { id: 1, name: 'verTareas', description: 'desc', roles: [] }; // Add roles
  ...
  describe('remove', () => {
    it('should delete a permission', async () => {
      const permission: Permission = { id: 1, name: 'x', description: 'y', roles: [] }; // Add roles
