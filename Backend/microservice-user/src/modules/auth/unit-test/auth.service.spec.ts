...
import { Role } from '../../roles/entities/role.entity'; // Asumiendo esta entidad
import { Permission } from '../../permissions/entities/permission.entity'; // Asumiendo esta entidad
...
describe('AuthService', () => {
  ...
  describe('forgotPassword', () => {
    ...
    it('should throw BadRequestException if user is not found', async () => {
      mockUsersService.findOneByEmailWithRolesAndPermissions.mockResolvedValue(
        null,
      );
  ...
  describe('restorePassword', () => {
    ...
    it('should successfully update the user password', async () => {
      ...
      expect(
        usersService.findOneByEmailWithRolesAndPermissions,
      ).toHaveBeenCalledWith(restoreDto.email);
    ...
    it('should throw BadRequestException if user is not found', async () => {
      ...
      await expect(service.restorePassword(restoreDto)).rejects.toThrow(
        BadRequestException,
      );
      await expect(service.restorePassword(restoreDto)).rejects.toThrow(
        'Email not found',
  ...
  describe('validateTokenAndPermissions', () => {
    ...
    it('should return true if token is valid and user has all required permissions', async () => {
      const result = await service.validateTokenAndPermissions(
        authHeader,
        requiredPermissions,
      );
